...
for e in range(3):
    ...
    model_save_path = 'output/sbert_polarity_prediction_' + model_name.replace("/", "-")
    ...
    dense_model = Dense.Dense(in_features=4*word_embedding_model.get_word_embedding_dimension(), out_features=2)
