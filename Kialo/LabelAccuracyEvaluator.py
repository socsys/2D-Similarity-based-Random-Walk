...
class LabelAccuracyEvaluator():
    ...
    def __init__(self, dataloader: DataLoader, name: str = "", softmax_model = None, write_csv: bool = True):
        ...
        self.csv_file = "2D_accuracy_evaluation"+name+"_results.csv"
        self.csv_headers = [
                            "epoch",
                            "steps",
                            "accuracy",
                            "macro_f1",
                            "precision_class_0_attacking",
                            "precision_class_1_supporting",

                            "recall_class_0_attacking",
                            "recall_class_1_supporting",

                            "f1_class_0_attacking",
                            "f1_class_1_supporting",
