...
df = pd.read_csv("Equalized_two_LK_test_random_walk.csv")
...
df_sampled.to_csv("twoD_K_gpt.csv", index=False)
...
print("Metrics saved to twoD_Kialo_gpt.csv as percentages")