...
for i in range (3):
    ...
    df = pd.read_csv("top_LG_test_random_walk.csv") # or random_LG or 2D_LG...
    ...
    df_sampled.to_csv("top_G_gpt.csv", index=False)
    ...
    print("Metrics saved to top_Guest_gpt.csv as percentages")