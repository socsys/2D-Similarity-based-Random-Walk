...
df = pd.read_csv("Equalized_two_LG_test_random_walk.csv")
...
df_sampled.to_csv("twoD_G_gpt.csv", index=False)
...
#metrics_df.to_csv("twoD_Guest_gpt.csv", index=False)
metrics_df.to_csv("twoD_Guest_gpt.csv", mode='a', index=False, header=False)

# --- Optional: print to confirm ---
print("Metrics saved to twoD_Guest_gpt.csv as percentages")