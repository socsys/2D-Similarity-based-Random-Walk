...
one_train = pd.read_csv("one_GG_train_random_walk.csv")
one_test = pd.read_csv("one_GG_test_random_walk.csv")
full_train = pd.read_csv("GG_train_random_walk.csv")
full_test = pd.read_csv("GG_test_random_walk.csv")
...
two_train.to_csv("two_GG_train_random_walk.csv", index=False)
two_test.to_csv("two_GG_test_random_walk.csv", index=False)
...
two_train_unstructured.to_csv("two_G_train_random_walk.csv", index=False)
two_test_unstructured.to_csv("two_G_test_random_walk.csv", index=False)

print("✅ Done. Files saved:")
print("- two_GG_train_random_walk.csv")
print("- two_GG_test_random_walk.csv")
print("- two_G_train_random_walk.csv")
print("- two_G_test_random_walk.csv")
