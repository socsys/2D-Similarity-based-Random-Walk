...
cols.append('label')
#pd.DataFrame(train_samples, columns=cols).to_csv('Guest/random-walks/GG_train_simil_random_walk.csv', index=False)
#pd.DataFrame(dev_samples, columns=cols).to_csv('Guest/random-walks/GG_test_simil_random_walk.csv', index=False)
