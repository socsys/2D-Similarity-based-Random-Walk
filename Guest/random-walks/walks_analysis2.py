...
def plot_comparison_bar():
    """Plot a bar plot comparing average scores for each label in relevance_scores (2D Walk)
    and relevance_scores1 (1D Walk), with professional error bars (mean ± std)."""
    ...
    spacing_factor = 1.5
    x = np.arange(num_labels) * spacing_factor
    width = 0.3 / spacing_factor
